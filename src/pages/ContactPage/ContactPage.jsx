...
function ContactPage() {
    return (
        <div className="min-h-screen bg-gradient-to-r from-gray-900 to-gray-600 flex items-center justify-center">
            <form className='flex flex-col items-center w-full max-w-lg p-5 bg-gray-800 text-white rounded-lg'>
                <div className='text-4xl mb-8 text-center'>İletişim</div>
